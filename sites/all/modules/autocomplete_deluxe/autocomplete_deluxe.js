...
(function($) {
  ...
  Drupal.autocomplete_deluxe = function(input, settings) {
    ...
    if (this.multiple) {
      ...
      this.source.container = this.jqObject.parent().parent().parent().children('.autocomplete-deluxe-values');
      //EDIT FINLET BV
    }
    this.source.init();
  ...
  Drupal.autocomplete_deluxe.ajaxSource.prototype.init = function() {
    if (this.multiple) {
      ...
      this.valueField = this.autocomplete.jqObject.parent().parent().parent().children('div.autocomplete-deluxe-value-container').children().children().children();
      //EDIT FINLET BV
